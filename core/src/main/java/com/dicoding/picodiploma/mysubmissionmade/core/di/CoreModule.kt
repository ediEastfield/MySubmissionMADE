package com.dicoding.picodiploma.mysubmissionmade.core.di

import androidx.room.Room
import com.dicoding.picodiploma.mysubmissionmade.core.data.MovieRepository
import com.dicoding.picodiploma.mysubmissionmade.core.data.source.local.LocalDataSource
import com.dicoding.picodiploma.mysubmissionmade.core.data.source.local.room.MovieDatabase
...
val databaseModule = module {
    ...
    single {
        val passphrase: ByteArray = SQLiteDatabase.getBytes("eastfield".toCharArray())
